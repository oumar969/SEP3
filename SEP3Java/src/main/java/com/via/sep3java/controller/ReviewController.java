...
@RestController @RequestMapping("/review") public class ReviewController
{
  @Autowired private ReviewRepository reviewRepository;

  @PostMapping("/create") public ResponseEntity<?> createReview(
  ...
  @PutMapping("/update/{uuid}") public ResponseEntity<?> updateReview(
  ...
  @DeleteMapping("/delete/{uuid}") public ResponseEntity<?> deleteReview(
  ...
  @GetMapping("/get/{uuid}") public ResponseEntity<?> getReview(
      @PathVariable String uuid)
  {
    Review review = reviewRepository.findByUuid(uuid);
    if (review == null)
