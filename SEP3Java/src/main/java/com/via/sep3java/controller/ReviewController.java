...
public class ReviewController
{
  ...
  public ResponseEntity<?> updateReview(@PathVariable String uuid, @RequestBody Map<String, String> body) {
    ...
    return new ResponseEntity<>("Review with UUID " + uuid + " updated successfully.", HttpStatus.OK);
  }
  ...
  public ResponseEntity<?> deleteReview(@PathVariable String uuid) {
    ...
    return new ResponseEntity<>("Review with UUID " + uuid + " deleted successfully.", HttpStatus.OK);
  }
}